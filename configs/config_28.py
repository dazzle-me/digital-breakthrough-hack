_base_ = '/workspace/rlh/mmsegmentation/configs/swin/upernet_swin_large_patch4_window7_512x512_pretrain_224x224_22K_160k_ade20k.py'
...
checkpoint_file = '/workspace/rlh/work_dirs/exp37/best_mIoU_iter_296000.pth'
# stride_size = 90
# h_dim = 1440
# w_dim = 2560
...
data = dict(
    ...
    train=dict(
        ...
        split='stratified_split_noval/train.txt'
    ),
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ...
        split='stratified_split_noval/val.txt'
    ),
    test=dict(
        type=dataset_type,
        data_root=data_root,
        ...
        ann_dir=ann_dir,
        pipeline=test_pipeline,
        split='stratified_split_noval/test.txt'
    )
)
