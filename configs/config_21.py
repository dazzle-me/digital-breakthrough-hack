...
model = dict(
    ...
    decode_head=dict(
        sampler=dict(type='OHEMPixelSampler', thresh=0.7, min_kept=100_000),
        type='UPerHead',
    ...
    train_cfg=dict(),
    # test_cfg=dict(mode='slide', crop_size=crop_size, stride=(stride_size, 0))
