...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(2560, 1440), ratio_range=(0.5, 2.0)),
...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(type='LoadAnnotations'),
            dict(
                type='Resize', img_scale=(2560, 1440), ratio_range=(0.5, 2.0)),
            dict(
    ...
    test=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                img_scale=(2560, 1440),
                flip=True,
                img_ratios=[0.75, 0.85, 1.0, 1.15, 1.33],
                transforms=[
                    dict(type='Resize', keep_ratio=True),
                    dict(type='RandomFlip'),
                    dict(
...
checkpoint_config = dict(by_epoch=False, interval=999999999)
evaluation = dict(
...
gpu_ids = range(0, 2)
device = 'cuda'
work_dir = '/workspace/rlh/work_dirs/exp37/'
auto_resume = True
