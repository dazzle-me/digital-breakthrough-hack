_base_ = '/workspace/rlh/mmsegmentation/configs/swin/upernet_swin_base_patch4_window12_512x512_160k_ade20k_pretrain_384x384_22K.py'
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=crop_size, stride=(0, stride_size // 2))
)
